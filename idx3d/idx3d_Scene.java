	...
	// D A T A   M A N A G E M E N T
		...
		public void rebuild()
		{
			if (objectsNeedRebuild)
			{
				...
				Enumeration enumm=objectData.elements();
				for (int i=objects-1;i>=0;i--)
				{
					object[i]=(idx3d_Object)enumm.nextElement();
					object[i].id=i;
					object[i].rebuild();
				}
			...
			if (lightsNeedRebuild)
			{
				...
				Enumeration enumm=lightData.elements();
				for (int i=lights-1;i>=0;i--) light[i]=(idx3d_Light)enumm.nextElement();
