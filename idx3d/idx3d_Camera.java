...
public class idx3d_Camera
{
	...
	// P U B L I C   M E T H O D S
		...
		void rebuildMatrices()
		{
            ...
            // Code inserted by DM Auslander for the case in which
            // forward and up are in the same direction (and thus don't
            // define a normal). Choice of z as "up" is arbitrary
            float dot = idx3d_Vector.angle(up, forward);
            if((Math.abs(dot) - 1.0) < 1.0e-5)
            {
